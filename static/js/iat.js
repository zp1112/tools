...
var IFlyIatSession = (function (window, navigator) {
    ...
    return function (setting) {
        ...
        (function () {
            ...
            window.volumeEvent = volumeCheck;
            //环境变量判断
            utils.getBrowserId();
        ...
        this.start = function (iat_params_obj) {
            serverParam = iat_params_obj.params +
              " browser_id=" + env.browserId + ",host=" + env.host;
            iatEvent.startRecord();
        };
        /*
